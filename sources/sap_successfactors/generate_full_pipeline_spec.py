...
def build_entity_registry():
    ...
    rest_entities = {
        ...
        "EmployeeCompForceCommentDTO": {"pks": ["commentId"], "cursor": None, "ing": "snapshot"},
        "PBCReplicationData": {"pks": ["id", "startDate", "endDate"], "cursor": None, "ing": "snapshot"},
        "SymbolicAccountData": {"pks": ["id"], "cursor": None, "ing": "snapshot"},
        "EmployeeGroupingData": {"pks": ["id"], "cursor": None, "ing": "snapshot"},
